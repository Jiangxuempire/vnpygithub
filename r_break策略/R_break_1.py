...
class RBreakStrategy30M(CtaTemplate):
    """"""
    author = "KeKe"
    ...
    def __init__(self, cta_engine, strategy_name, vt_symbol, setting):
        """"""
        super(RBreakStrategy30M, self).__init__(
            cta_engine, strategy_name, vt_symbol, setting
        )

        self.bg = BarGenerator(
            self.on_bar, 30, self.on_30min_bar, interval=Interval.MINUTE)
    ...
    def on_30min_bar(self, bar: BarData):
        """
        Callback of new 30min_bar data update.
        """
        self.cancel_all()
